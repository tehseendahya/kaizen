...
export default function Physics152Course() {
  ...
  // Common syllabus Q&A (kept for potential future use)
  ...
  // Removed search dropdown UI to match CS201; retain structures if needed later.
            ...
            <div className="w-full">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="p-5 rounded-xl border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-pink-50">
                    <div className="flex items-center space-x-3 mb-2">
                      <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7h18M3 12h18M3 17h18"/></svg>
                      <h4 className="font-bold text-lg text-purple-900">Lab</h4>
                    </div>
                    <p className="text-sm text-purple-900 opacity-80">Electrostatics and electric field mapping</p>
                  </div>
                  <div className="p-5 rounded-xl border-2 border-orange-200 bg-gradient-to-br from-orange-50 to-amber-50">
                    <div className="flex items-center space-x-3 mb-2">
                      <svg className="w-6 h-6 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg>
                      <h4 className="font-bold text-lg text-orange-900">Project</h4>
                    </div>
                    <p className="text-sm text-orange-900 opacity-80">Mini‑project — Field visualization</p>
                  </div>
                  <div className="p-5 rounded-xl border-2 border-green-200 bg-gradient-to-br from-green-50 to-emerald-50">
                    <div className="flex items-center space-x-3 mb-2">
                      <svg className="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                      <h4 className="font-bold text-lg text-green-900">Checklist</h4>
                    </div>
                    <p className="text-sm text-green-900 opacity-80">Unit mastery checklist</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8">
                <button
                  onClick={() => handleLessonClick(courseData.units[0].lessons[0].id)}
